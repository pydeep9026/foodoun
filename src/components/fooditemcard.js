...
const FoodItemCard = ({ foodItem, deliveryApps }) => {
  ...
  return (
    <>
      ...
      {
      couponCode === "FOODOUN60" && codeapplied &&
      <Confetti
      width={width}
      height={height}
      numberOfPieces={500}
    ...
    />
        ...
        <div className="popupbody">
          ...
          <div className="deliveryinfo">
            ...
            <div className="details" style={{marginTop:"-20px"}}>
              {codeapplied && couponCode==="FOODOUN60" ? <div className="price"><span style={{textDecoration:"line-through",color:"grey"}}>&#x20B9;{selectedApp.price}</span> &#x20B9;{selectedApp.price*0.4}</div>:
        ...
        <div className="popupfooter">
          ...
          <p style={{color:"red",fontSize:"14px",marginTop:"-10px",marginBottom:"10px"}}>
             Apply FOODOUN60 to get flat 60% off on your {foodItem.name} order.
          </p>
          <button style={{width:"80%",marginRight:"25%"}}><a style={{textDecoration:"none",color:"white"}} href='https://foodounpre.netlify.app'>Buy now</a></button>
        </div>
      </div>
        </>
      )}
